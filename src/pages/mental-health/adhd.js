...
const Adhd = () => {
  ...
  const getADHDPageDetalis = () => {
    getInnerPageDetails(STATICTODYNAMIC, "mental_health", "ADHD").then(
      (response) => {
        const {
        ...
        setMetaData(meta_data.find((item) => item.page_name === "adhd"));
        setGlobalSetting(
      ...
      <div className="top-sec-gap adHd-condition">
        ...
        {symptomsBlock && symptomsBlock.length > 0 && (
          <>
            ...
            <div className="text-center symptoms-bottom-sec">
              <div className="container ">
                      ...
                      {index % 2 === 0 ? (
                        <>
                          <div className="row">
                            <div
                              ...
                              key={index}
                              style={{ order: window.innerWidth < 767 ? 1 : 'unset' }}
                            >
                              <div className="img-box">
                                <img
                                  src={item.image}
                        ...
                        <>
                          <div className="row">
                            ...
                            <div className="col-xl-6 col-lg-6 col-md-6 col-12 col-sm-12 first-div second" style={{ order: window.innerWidth < 767 ? 1 : 'unset' }}>
                              <div className="img-box">
                                <img
                                  src={item.image}
                                  className="img-fluid"
