...
const Anger = () => {
  ...
  const getAngerPageDetalis = () => {
    getInnerPageDetails(STATICTODYNAMIC, "mental_health", "Anger").then(
      (response) => {
        const {
      ...
      setMetaData(meta_data.find((item) => item.page_name === "anger"));
        setGlobalSetting(
