...
const PremenstrualDysporic = () => {
  ...
  document.title = "Premenstrual Dysporic Disorder | Ada";

  useEffect(() => {
    getPremenstrualPageDetalis();
    window.scroll(0, 0);
  }, []);
  ...
  const getPremenstrualPageDetalis = () => {
    getInnerPageDetails(
      STATICTODYNAMIC,
      "mental_health",
      ...
      setMetaData(meta_data.find((item) => item.page_name === "premenstrual-dysphoric-disorder"));
      setGlobalSetting(
...
export default PremenstrualDysporic;
