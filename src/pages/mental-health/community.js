...
const Community = () => {
  ...
  document.title = "LGBTQIA+ Community | Ada";

  useEffect(() => {
    getCommunityPageDetalis();
    window.scroll(0, 0);
  }, []);
  ...
  const getCommunityPageDetalis = () => {
    getInnerPageDetails(
      ...
      setMetaData(meta_data.find((item) => item.page_name === "LGNTQUIA-community"));
      setGlobalSetting(
